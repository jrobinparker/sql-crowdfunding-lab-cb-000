...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  return "SELECT Projects.title, SUM(Pledges.amount) FROM Projects JOIN Pledges ON Pledges.project_id = Projects.id GROUP BY Projects.title HAVING SUM(Pledges.amount) - Projects.funding_goal LIMIT SUM(Pledges.amount) - Projects.funding_goal;"
end
